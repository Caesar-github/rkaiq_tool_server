...
void deinit(std::shared_ptr<easymedia::Flow> &video_cap_flow,
            std::shared_ptr<easymedia::Flow> &sink_flow) {
...
void ImageProcess(unsigned char *buffer, unsigned int buffer_size,
                  unsigned int present_time, int nat_type) {
