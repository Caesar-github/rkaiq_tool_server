...
public:
  ...
  virtual ~SinkFlow();
  static const char *GetFlowName() { return "sink_flow"; }
...
SinkFlow::~SinkFlow() { StopAllThread(); }
...
const char *FACTORY(SinkFlow)::ExpectedInputDataType() { return nullptr; }
const char *FACTORY(SinkFlow)::OutPutDataType() { return ""; }
