...
void init_mmap(struct capture_info* cap_info) {
    ...
    for(cap_info->n_buffers = 0; cap_info->n_buffers < req.count;
        ++cap_info->n_buffers) {
...
void init_userp(struct capture_info* cap_info, unsigned int buffer_size) {
    ...
    for(cap_info->n_buffers = 0; cap_info->n_buffers < 4;
        ++cap_info->n_buffers) {
